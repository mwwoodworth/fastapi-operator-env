...
# Basic workflow endpoints (no path params)
@router.post("/")
...
# Trigger management routes (specific paths before wildcards)
...
# Workflow-specific routes (with {workflow_id} path param) - MUST BE LAST
